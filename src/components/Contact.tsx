        ...
        <div className="contact-grid">
          ...
          <div className="contact-channels">
            ...
            <a
              ...
              className="channel-card channel-card--facebook"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="Visit our Facebook page"
            >
              <span className="channel-icon">{FB_ICON}</span>
              <div className="channel-text">
                <span className="channel-name">Facebook</span>
                <span className="channel-desc">Follow our updates</span>
              </div>
            </a>
            ...
            >
              <span className="channel-icon">{IG_ICON}</span>
              <div className="channel-text">
                <span className="channel-name">Instagram</span>
                <span className="channel-desc">See our portfolio</span>
              </div>
            </a>
          </div>
